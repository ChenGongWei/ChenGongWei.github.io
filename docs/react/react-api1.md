---
title: React API（组件类）
excerpt: 我们在用React开发的时候，真正用到的React的api很少，但其实React暴露出来的api非常多，而且这些api并非没有用，都有它们各自的应用场景。我会将React api分成组件类、工具类、hooks、react-dom四个类别来进行复习，本文针对的是组件类的。
index_img: https://little_lu.gitee.io/images/blog/react/react-api1.jpg
banner_img: https://little_lu.gitee.io/images/blog/react/react-api1.jpg
tags: [React, API, 学习笔记]
...
```
<img src="https://little_lu.gitee.io/images/blog/react/react-api/profiler.png" width="700px">
...
```
**结果：**
<img src="https://little_lu.gitee.io/images/blog/react/react-api/strictMode.png" width="800px">